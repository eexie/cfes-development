...
if ( ! defined( 'ABSPATH' ) )
	...
	function team_manager_free_custom_post_type(){
			$labels = array(
				...
				'all_items'             => __( 'Members', 'team-manager-free' ),
	...
	{
		add_submenu_page('edit.php?post_type=team_mf', __('Create Team', 'team-manager-free'), __('Create Team', 'team-manager-free'), 'manage_options', 'post-new.php?post_type=team_mf_team');
	}
	...
	function team_manager_free_custom_inner_custom_boxes( $post ) {
		...
		<input type="text" name="contact_number_input" placeholder="417-xxx-xxxx" id="contact_number_input" class="regular-text code" value="<?php echo get_post_meta($post->ID, 'contact_number', true); ?>" />
		<hr class="horizontalRuler"/>
		...
		<p style="color:red"><label for="company_intro_box"><strong><?php _e('Member Social Info', 'team-manager-free');?></strong></label></p>
		<hr class="horizontalRuler"/>
...
add_action('admin_menu', 'team_manager_free_submenu_pages');	 */	
	...
	<div id="tabs-container">
		<ul class="tabs-menu">
			<li><a href="#tab-1"><i class="fa fa-gear"></i><?php _e('Team Settings', 'team-manager-free')?></a></li>
			<li><a href="#tab-2"><i class="fa fa-paint-brush" aria-hidden="true"></i><?php _e('Color Settings', 'team-manager-free')?></a></li>
			<li><a href="#tab-3"><i class="fa fa-paint-brush" aria-hidden="true"></i><?php _e('Social Color Settings', 'team-manager-free')?></a></li>
			<li><a href="#tab-4"><i class="fa fa-life-ring" aria-hidden="true"></i><?php _e('Support', 'team-manager-free')?></a></li>
		</ul>
		<div class="tab">
		<?php
			...
			<div class="wrap">
				...
				<tr valign="top">
					...
					<td style="vertical-align:middle;">
						...
						<span class="team_manager_hint"><?php echo __('Select Team Showcase Category.', 'team-manager-free'); ?></span>	
					</td>
				</tr>
				...
				<tr valign="top">
					...
					<td style="vertical-align:middle;">
						<select class="timezone_string" name="team_manager_free_post_themes">
							...
							<option value="theme5" disabled <?php if($team_manager_free_post_themes=='theme5') echo "selected"; ?> ><?php _e('Team Theme 5 (Update Soon ..)', 'team-manager-free')?></option>
							<option value="theme6" disabled <?php if($team_manager_free_post_themes=='theme6') echo "selected"; ?> ><?php _e('Team Theme 6 (Update Soon ..)', 'team-manager-free')?></option>
							<option value="theme7" disabled <?php if($team_manager_free_post_themes=='theme7') echo "selected"; ?> ><?php _e('Team Theme 7 (Update Soon ..)', 'team-manager-free')?></option>
							<option value="theme8" disabled <?php if($team_manager_free_post_themes=='theme8') echo "selected"; ?> ><?php _e('Team Theme 8 (Update Soon ..)', 'team-manager-free')?></option>
							<option value="theme9" disabled <?php if($team_manager_free_post_themes=='theme9') echo "selected"; ?> ><?php _e('Team Theme 9 (Update Soon ..)', 'team-manager-free')?></option>
							<option value="theme10" disabled <?php if($team_manager_free_post_themes=='theme10') echo "selected"; ?> ><?php _e('Team Theme 10 (Update Soon ..)', 'team-manager-free')?></option>
							<option value="theme11" disabled <?php if($team_manager_free_post_themes=='theme11') echo "selected"; ?> ><?php _e('Team Theme 11 (Update Soon ..)', 'team-manager-free')?></option>
							<option value="theme12" disabled <?php if($team_manager_free_post_themes=='theme12') echo "selected"; ?> ><?php _e('Team Theme 12 (Update Soon ..)', 'team-manager-free')?></option>
							<option value="theme13" disabled <?php if($team_manager_free_post_themes=='theme13') echo "selected"; ?> ><?php _e('Team Theme 13 (Update Soon ..)', 'team-manager-free')?></option>
							<option value="theme14" disabled <?php if($team_manager_free_post_themes=='theme14') echo "selected"; ?> ><?php _e('Team Theme 14 (Update Soon ..)', 'team-manager-free')?></option>
							<option value="theme15" disabled <?php if($team_manager_free_post_themes=='theme15') echo "selected"; ?> ><?php _e('Team Theme 15 (Update Soon ..)', 'team-manager-free')?></option>
							<option value="theme16" disabled <?php if($team_manager_free_post_themes=='theme16') echo "selected"; ?> ><?php _e('Team Theme 16 (Update Soon ..)', 'team-manager-free')?></option>
							<option value="theme17" disabled <?php if($team_manager_free_post_themes=='theme17') echo "selected"; ?> ><?php _e('Team Theme 17 (Update Soon ..)', 'team-manager-free')?></option>
							<option value="theme18" disabled <?php if($team_manager_free_post_themes=='theme18') echo "selected"; ?> ><?php _e('Team Theme 18 (Update Soon ..)', 'team-manager-free')?></option>
							<option value="theme19" disabled <?php if($team_manager_free_post_themes=='theme19') echo "selected"; ?> ><?php _e('Team Theme 19 (Update Soon ..)', 'team-manager-free')?></option>
							<option value="theme20" disabled <?php if($team_manager_free_post_themes=='theme20') echo "selected"; ?> ><?php _e('Team Theme 20 (Update Soon ..)', 'team-manager-free')?></option>
							<option value="theme21" disabled <?php if($team_manager_free_post_themes=='theme21') echo "selected"; ?> ><?php _e('Team Theme 21 (Update Soon ..)', 'team-manager-free')?></option>
							<option value="theme22" disabled <?php if($team_manager_free_post_themes=='theme22') echo "selected"; ?> ><?php _e('Team Theme 22 (Update Soon ..)', 'team-manager-free')?></option>
							<option value="theme23" disabled <?php if($team_manager_free_post_themes=='theme23') echo "selected"; ?> ><?php _e('Team Theme 23 (Update Soon ..)', 'team-manager-free')?></option>
							<option value="theme24" disabled <?php if($team_manager_free_post_themes=='theme24') echo "selected"; ?> ><?php _e('Team Theme 24 (Update Soon ..)', 'team-manager-free')?></option>
							<option value="theme25" disabled <?php if($team_manager_free_post_themes=='theme25') echo "selected"; ?> ><?php _e('Team Theme 25 (Update Soon ..)', 'team-manager-free')?></option>
							<option value="theme26" disabled <?php if($team_manager_free_post_themes=='theme26') echo "selected"; ?> ><?php _e('Team Theme 26 (Update Soon ..)', 'team-manager-free')?></option>
							<option value="theme27" disabled <?php if($team_manager_free_post_themes=='theme27') echo "selected"; ?> ><?php _e('Team Theme 27 (Update Soon ..)', 'team-manager-free')?></option>
							<option value="theme28" disabled <?php if($team_manager_free_post_themes=='theme28') echo "selected"; ?> ><?php _e('Team Theme 28 (Update Soon ..)', 'team-manager-free')?></option>
							<option value="theme29" disabled <?php if($team_manager_free_post_themes=='theme29') echo "selected"; ?> ><?php _e('Team Theme 29 (Update Soon ..)', 'team-manager-free')?></option>
							<option value="theme30" disabled <?php if($team_manager_free_post_themes=='theme30') echo "selected"; ?> ><?php _e('Team Theme 30 (Update Soon ..)', 'team-manager-free')?></option>
						</select><br/>
				...
				<tr valign="top">
					...
					<select class="timezone_string" name="team_manager_free_post_column">
						...
						<option value="1" disabled <?php if($team_manager_free_post_column=='1') echo "selected"; ?> ><?php _e('1 Column (Update Soon ..)', 'team-manager-free')?></option>
						<option value="4" disabled <?php if($team_manager_free_post_column=='4') echo "selected"; ?> ><?php _e('4 Column (Update Soon ..)', 'team-manager-free')?></option>
					</select>
		...
		<div id="tab-3" class="tab-content">
			<div class="wrap">
				<table class="form-table">
				<tr valign="top">
					<th scope="row"><label style="padding-left:10px;" for="team_manager_free_header_font_color"><?php echo __('Update Soon:', 'team-manager-free'); ?></label></th>
				</tr>
				</table>
			</div>
		</div>
