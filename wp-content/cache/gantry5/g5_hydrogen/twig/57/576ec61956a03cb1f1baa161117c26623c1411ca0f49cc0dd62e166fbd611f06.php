...
class __TwigTemplate_5783b096cc5e0cab6a6d38e84401546fdd274f7ecf7463df035a3a58b5142a0c extends Twig_Template
{
...
";
        ...
        if (twig_trim_filter(($context["html"] ?? null))) {
         ...
         class=\"g-block";
            // line 25
            echo (($this->getAttribute($this->getAttribute(($context["segment"] ?? null), "attributes", array()), "variations", array())) ? ((" " . twig_escape_filter($this->env, twig_join_filter($this->getAttribute($this->getAttribute(($context["segment"] ?? null), "attributes", array()), "variations", array()), " ")))) : (""));
            echo (($this->getAttribute($this->getAttribute(($context["segment"] ?? null), "attributes", array()), "class", array())) ? ((" " . twig_escape_filter($this->env, twig_join_filter($this->getAttribute($this->getAttribute(($context["segment"] ?? null), "attributes", array()), "class", array()), " ")))) : (""));
            echo " ";
            echo call_user_func_array($this->env->getFilter('toGrid')->getCallable(), array($this->getAttribute($this->getAttribute(($context["segment"] ?? null), "attributes", array()), "size", array())));
            echo "\">
        ";
            // line 26
...
";
    ...
    {
        return new Twig_Source("", "@nucleus/layout/block.html.twig", "/Users/eexie/Documents/git/cfes/wp-content/plugins/gantry5/engines/nucleus/templates/layout/block.html.twig");
    }
}
